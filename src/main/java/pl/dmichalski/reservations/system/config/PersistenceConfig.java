package pl.dmichalski.reservations.system.config;
...
@EnableJpaRepositories(basePackages = "pl.dmichalski.reservations.business.domain.repository")
public class PersistenceConfig {

    public static final String RESERVATIONS_PERSISTENCE_UNIT_NAME = "reservations-pu";
    private static final String ENTITY_BASE_PACKAGE = "pl.dmichalski.reservations.business.domain.entity";
